...
const Registered = () => {
  ...
  return (
    <div className="bg-[#f0f2f5] relative h-page">
      <div className="mx-auto container py-20 px-6">
          <div className="grid grid-cols-3 gap-10">
          {event.map((eve)=>(
              <div className="rounded">
                  <div className="w-full h-64 flex flex-col justify-between dark:bg-gray-700 dark:border-gray-700 rounded-lg border border-gray-400 hover:bg-gray-800 hover:scale-105  mb-6 py-5 px-4" onClick={() => { navigate('/description', { state: {eve,reg:1} }) }}> 
                      <div>
